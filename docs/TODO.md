...
| T14 | 多账户 paper:先上 **volx2-1.5x**(回测冠军)+ **volx2-nochase**(回测盲区,须真实成交验) | 单账户多策略会持仓合并/抢仓/熔断连坐;真实滑点只有 paper 能暴露(WLDS 的 $0.04) | `executor`/`autotrader` 读多套 key | 🔴 **等你开 Alpaca paper 账户 + 给 key**,我再改多账户代码 |
